...
(function( $ ) {
    ...
    redux.field_objects.softhopper_chat_bg = redux.field_objects.softhopper_chat_bg || {};
    ...
    redux.field_objects.softhopper_chat_bg.init = function( selector ) {

        if ( !selector ) {
            selector = $( document ).find( '.redux-container-softhopper_chat_bg:visible' );
        }
